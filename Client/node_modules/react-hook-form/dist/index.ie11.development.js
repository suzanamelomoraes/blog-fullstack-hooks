...
var skipValidation = (function (_a) {
    var isOnBlur = _a.isOnBlur, isOnChange = _a.isOnChange, isReValidateOnBlur = _a.isReValidateOnBlur, isReValidateOnChange = _a.isReValidateOnChange, isBlurEvent = _a.isBlurEvent, isSubmitted = _a.isSubmitted, isOnAll = _a.isOnAll;
    if (isOnAll) {
        return false;
    }
...
function useForm(_a) {
    ...
    var _j = modeRef.current, isOnSubmit = _j.isOnSubmit, isOnAll = _j.isOnAll;
        ...
        if (isRadioInput(ref) && options) {
            ...
            options.length > 1
                ? options.forEach(function (_a) {
                    ...
                    return (checkboxRef.checked = String(value).includes(checkboxRef.value));
                })
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            shouldSkipValidation = !isOnAll &&
                                skipValidation(__assign({ isBlurEvent: isBlurEvent,
                                    isReValidateOnChange: isReValidateOnChange,
                                    isReValidateOnBlur: isReValidateOnBlur, isSubmitted: isSubmittedRef.current }, modeRef.current));
    ...
    var control = __assign(__assign({ removeFieldEventListener: removeFieldEventListener,
        renderWatchedInputs: renderWatchedInputs,
        watchInternal: watchInternal,
        reRender: reRender, mode: modeRef.current, reValidateMode: {
        ...
        unmountFieldsStateRef: unmountFieldsStateRef }, (resolver ? { validateSchemaIsValid: validateResolver } : {})), commonProps);
...
var useFieldArray = function (_a) {
    ...
    var shouldRender;
    var getDefaultValues = function () { return __spread((get(fieldArrayDefaultValues.current, name) ||
        ...
        if (readFormStateRef.current.isDirty ||
            ...
            isDirtyRef.current =
                isUndefined(flagOrFields) ||
                    getIsFieldsDifferent(flagOrFields.map(function (_a) {
                        if (_a === void 0) { _a = {}; }
...
var Controller = function (_a) {
    ...
    var _d = __read(React.useState(getInitialValue()), 2), value = _d[0], setInputStateValue = _d[1];
